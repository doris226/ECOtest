    ...
    public partial class 自創劇情 : Event
    {
        ...
        void 首次對話(ActorPC pc, BitMask<失眠的人> mark)
        {
            if (!mark.Test(失眠.首次對話))
            {
                ...
                Say(pc, 158, "啊你好...", "失眠的人");
                Say(pc, 158, "明明已經三天三夜都沒睡了卻怎麼也睡不著啊", "失眠的人");
        ...
        void 給安眠藥(ActorPC pc, BitMask<失眠的人> mark)
        {
            ...
            Say(pc, 158, "（好像聽到了甚麼很不得了的內容）");
            Say(pc, 158, "再去找找其他能助眠的東西吧");
        }
        void 給安眠枕頭(ActorPC pc, BitMask<失眠的人> mark)
        {
            ...
            Say(pc, 158, "這枕頭是奇蹟啊！！......ZZz", "失眠的人");
            Say(pc, 158, "（看來是有效果了？）");
            Say(pc, 158, "......", "失眠的人");
            Say(pc, 158, "...", "失眠的人");
            Say(pc, 158, "灰常感謝...Zzz", "失眠的人");
